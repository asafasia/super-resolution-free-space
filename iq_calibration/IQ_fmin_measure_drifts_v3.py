...
# from instruments_py27.anritsu import Anritsu_MG #<-- uncomment if needed
# from instruments_py27.E8241A import E8241A_MG
from instruments_py27.M9347A import M9347A_MG #<-- uncomment if needed
from instruments_py27.spectrum_analyzer import N9010A_SA

MG_class = M9347A_MG#Anritsu_MG #E8241A_MG # - choose relevant signal generator (M9347A_MG/Anritsu_MG)
...
MG_address = ("TCPIP0::DESKTOP-VT04ESJ::hislip1::INSTR",2)# #"GPIB0::28::INSTR"#"GPIB0::5::INSTR" #- for Anritsu #
SA_address = "TCPIP0::192.168.137.177::inst0::INSTR"

#OPX ports to which the I,Q ports of the IQ mixer are connected - change as needed
I_port = 1 #
Q_port = 2#

LOAmp = 0.0#10.0#18.0 #dBm #
LOFreq = 5150.0#4830.0#4750.0#5900.0#4600.0#4830.0#5900.0#4830.0#5673.0#5470.0#4830.0# in MHZ !!6000.0#   6000.0#5678.5#4582.8#5678.5#4582.8#5830.5+150#4381#4151#4160 #MHz - change as needed
